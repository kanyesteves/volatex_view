<template>
  <div class=" card">
    <div class="card flex justify-center">
      <Dialog v-model:visible="visible" modal header="Editar usuário" :style="{ width: '45rem' }" :breakpoints="{ '960px': '90vw', '640px': '95vw' }">
        ...
        <div :class="$style.space_bottons">
          ...
          <Button :style="{ 'margin-left': '1rem' }" type="button" label="Salvar" severity="success" @click="onSaveUser"></Button>
        </div>
